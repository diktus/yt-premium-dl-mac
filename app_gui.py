...
class YTProApp(ctk.CTk):
    ...
    def check_binaries(self):
        ...
        for name, cmd in checks:
            try:
                ...
                result = subprocess.run(cmd, capture_output=True, text=True, timeout=10, env=test_env)
    ...
    def update_progress(self, line):
        """Mengekstrak data progres dari log yt-dlp secara visual"""
        # RegEx untuk mencari persentase: [download]  10.5% of ...
        ...
        # RegEx untuk mencari kecepatan: ... at 5.23MiB/s ...
